...
systemSizes="6" # Must be sorted in ascending order!
failureCounts=(2) # For each system size, the corresponding failure count (on top of the correct nodes)
